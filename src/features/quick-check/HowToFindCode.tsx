    ...
    <div>
      ...
      <div className="mt-6 rounded-md bg-blue-50 p-3">
        <p className="text-xs text-blue-800">
          <strong>Tip:</strong> Look for requests to <code className="rounded bg-blue-100 px-1">google-analytics.com/collect</code> or{' '}
          <code className="rounded bg-blue-100 px-1">googleads.g.doubleclick.net</code>. The GCS/GCD value will be in the URL query parameters.
        </p>
      </div>
    </div>
  );
